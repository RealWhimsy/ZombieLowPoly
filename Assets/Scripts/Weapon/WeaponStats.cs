...
public static class WeaponStats
{
    public static Dictionary<string, Weapon> weaponStatDict = new Dictionary<string, Weapon>()
    {
        ...
        [Const.WeaponNames.Ak47] = new Weapon("w_ak47", 2, 30, 0.3f,
        ...
        [Const.WeaponNames.Python] = new Weapon("w_python", 3, 6, 0.6f, 
            Resources.Load("Prefabs/rifle_shell") as GameObject, 50, 5, false,
        ...
        [Const.WeaponNames.Mac10] = new Weapon("w_mac10", 3, 32, 0.1f, 
            Resources.Load("Prefabs/rifle_shell") as GameObject, 15, 20, false,
            (AudioClip) Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip) Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip) Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.P90] = new Weapon("w_p90", 3, 50, 0.1f,
            Resources.Load("Prefabs/rifle_shell") as GameObject, 10, 25, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.Aug] = new Weapon("w_aug", 2, 30, 0.3f,
            Resources.Load("Prefabs/rifle_shell") as GameObject, 25, 5, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.Scar] = new Weapon("w_scar", 2, 25, 0.3f,
            Resources.Load("Prefabs/rifle_shell") as GameObject, 40, 5, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.M4] = new Weapon("w_m4_custom", 2, 30, 0.3f,
            Resources.Load("Prefabs/rifle_shell") as GameObject, 25, 13, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.Awp] = new Weapon("w_awp", 2, 10, 0.9f,
            Resources.Load("Prefabs/rifle_shell") as GameObject, 100, 2, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.Svd] = new Weapon("w_svd", 2, 10, 0.3f,
            Resources.Load("Prefabs/rifle_shell") as GameObject, 80, 10, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.TwoBarrel] = new Weapon("w_twobarrel", 5, 2, 0.2f,
            Resources.Load("Prefabs/shotgun_shell") as GameObject, 60, 5, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.Spas] = new Weapon("w_spas", 2, 12, 0.6f,
            Resources.Load("Prefabs/shotgun_shell") as GameObject, 50, 5, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.M249] = new Weapon("w_m249", 1, 100, 0.1f,
            Resources.Load("Prefabs/rifle_shell") as GameObject, 20, 15, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),

        [Const.WeaponNames.Rpg] = new Weapon("w_rpg", 5, 1, 0.4f,
            Resources.Load("Prefabs/projectile_rpg") as GameObject, 200, 5, false,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
        ...
        [Const.WeaponNames.RamboKnife] = new Weapon("w_rambo_knife", 0, 0, 0.5f,
            Resources.Load("Prefabs/rifle_shell") as GameObject, 70, 1, true,
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/AK47_shot"),
            (AudioClip)Resources.Load("Sounds_Ingame/Weapons/Rifle_reload_1"),
            (AudioClip)Resources.Load("Sounds_Ingame/Bullets/Rifle_shell")),
